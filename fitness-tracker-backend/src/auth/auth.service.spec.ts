...
import { mockUser, sanitizedUser, mockConfigService } from '../test-utils/test-utils';
...
describe('AuthService - Security Tests', () => {
    ...
    describe('SECURITY: JWT token generation', () => {
        it('should sign tokens with correct payload (sub + email, no sensitive data)', async () => {
            ...
            await service.register({ email: 'new@example.com', username: 'newuser', password: 'pass123' });
